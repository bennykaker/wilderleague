/**
 * Seeds Black women actors — A-list, veterans, comedy, emerging, British Black.
 * Skips anyone already in DB. Safe to re-run.
 * Run with: npx tsx scripts/seed-black-women-actors.ts
 */
...
const ACTORS = [
  // A-list and established
  'Viola Davis', "Lupita Nyong'o", 'Angela Bassett', 'Halle Berry',
  'Taraji P. Henson', 'Kerry Washington', 'Gabrielle Union', 'Regina King',
  'Janelle Monáe', 'Zoe Saldana', 'Danai Gurira', 'Uzo Aduba',
  'Yvonne Orji', 'Meagan Good', 'Tika Sumpter', 'Rutina Wesley',
  'Adina Porter', 'Lorraine Toussaint', 'CCH Pounder', 'Pam Grier',

  // Veterans and legends
  'Cicely Tyson', 'Diahann Carroll', 'Phylicia Rashad', 'Alfre Woodard',
  'Lynn Whitfield', 'Jasmine Guy', 'Dawnn Lewis', 'Kim Fields',
  'Erika Alexander',

  // Comedy and mainstream
  'Queen Latifah', 'Jada Pinkett Smith', 'Nia Long', 'Sanaa Lathan',

  // British Black women
  'Thandiwe Newton', 'Naomie Harris', 'Sophie Okonedo', 'Freema Agyeman',
  'Letitia Wright', 'Michaela Coel', 'Jodie Turner-Smith', 'Naomi Ackie',
  'Wunmi Mosaku',

  // Emerging and current
  'Dominique Fishback', 'Teyonah Parris', 'Quinta Brunson', 'Sheryl Lee Ralph',
  'Janelle James', 'Niecy Nash', 'Regina Hall', 'Tiffany Haddish',
  'Issa Rae', 'Lena Waithe', 'Yvette Nicole Brown', 'Raven-Symoné',
  'Keke Palmer', 'Yara Shahidi', 'Zendaya', 'Storm Reid', 'Marsai Martin',
  'Amandla Stenberg', 'Logan Browning', 'DeWanda Wise',

  // Trans and non-binary
  'MJ Rodriguez', 'Indya Moore', 'Laverne Cox', 'Samira Wiley',

  // Character and indie
  'Adepero Oduye', 'Gugu Mbatha-Raw', 'Emayatzy Corinealdi',
  'Aunjanue Ellis', 'Nicole Beharie', 'Condola Rashad', 'Simone Missick',
  'Susan Kelechi Watson', 'Sydelle Noel', 'Bresha Webb', 'Erica Ash',
  'Essence Atkins', 'Amber Stevens West', 'Kylie Bunbury',
  'Megalyn Echikunwoke', 'Aja Naomi King', 'Nafessa Williams',
  'China Anne McClain', 'Ajiona Alexus', 'Angell Conwell',
]
  ...
  for (const name of unique) {
    try {
      ...
      const { error } = await supabase.from('actors').upsert({
        ...
        notes: 'seeded via seed-black-women-actors.ts',
      }, { onConflict: 'tmdb_id' })
