/**
 * Seeds Canadian actors — Atom Egoyan stable, Indigenous actors, comedians,
 * mainstream crossovers, sci-fi TV regulars.
 * Skips anyone already in DB. Safe to re-run.
 * Run with: npx tsx scripts/seed-canadian-actors.ts
 */
...
const ACTORS = [
  // Atom Egoyan / Canadian prestige cinema
  'Callum Keith Rennie', 'Don McKellar', 'Sarah Polley', 'Hugh Dillon',
  'Elias Koteas', 'Arsinée Khanjian', 'Gabrielle Rose', 'Bruce Greenwood',
  'Tom McCamus', 'Peter Outerbridge', 'Stephen McHattie', 'Molly Parker',
  'Pascale Bussières', 'Marie-Josée Croze', 'Roy Dupuis', 'Lothaire Bluteau',
  'Gabriel Arcand', 'Geneviève Bujold', 'Martha Henry', 'R.H. Thomson',
  'Kenneth Welsh', 'Art Hindle', 'Michael Ironside', 'Colm Feore',

  // Indigenous Canadian actors
  'Graham Greene', 'Tom Jackson', 'Gary Farmer', 'Adam Beach',
  'Tantoo Cardinal', 'Gordon Tootoosis', 'Tina Keeper', 'Margo Kane',
  'Lorne Cardinal', 'Jennifer Podemski', 'Raoul Trujillo',

  // Mainstream crossovers
  'Mia Kirshner', 'Dov Tiefenbach', 'Devon Sawa', 'Ryan Reynolds',
  'Brendan Fraser', 'Neve Campbell', 'Pamela Anderson', 'Mike Myers',
  'Jim Carrey', 'Dan Aykroyd', 'Martin Short', 'Eugene Levy',
  'Andrea Martin', 'Dave Thomas', 'Rick Moranis', 'Joe Flaherty',
  'Paul Gross', 'Kiefer Sutherland', 'Donald Sutherland', 'Leslie Nielsen',
  'William Shatner', 'Gordon Pinsent', 'Kate Nelligan', 'Wendy Crewson',
  'Claire Forlani', 'Sandrine Holt', 'Kristin Kreuk', 'Cobie Smulders',
  'Seth Rogen', 'Taylor Kitsch', 'Nathan Fillion',

  // Canadian character actors
  'Shawn Doyle', 'Yannick Bisson', 'Jonas Chernick', 'Aaron Poole',
  'Adam Butcher', 'Julian Richings', 'Glen Gould', 'Michael Riley',
  'David Ferry', 'Clark Johnson', 'Aidan Devine', 'Patrick McKenna',
  'Shaun Majumder', 'Enrico Colantoni', 'Callum Blue', 'Peter Stebbings',
  'Kristin Booth', 'Sarah Gadon', 'Linda Sorensen', 'Susan Hogan',
  'Cara Gee', 'Tommie-Amber Pirie', 'Adrian Holmes',

  // Stargate / Canadian sci-fi TV
  'Michael Shanks', 'Amanda Tapping', 'David Hewlett', 'Paul McGillion',
  'Rachel Luttrell', 'Torri Higginson', 'Rainbow Sun Francks',
  'Connor Trinneer', 'Lexa Doig',
]
  ...
  for (const name of unique) {
    try {
      ...
      const { error } = await supabase.from('actors').upsert({
        ...
        known_for,
        keywords: 'canadian; drama',
        casting_profile,
        nationality: 'Canadian',
        notes: 'seeded via seed-canadian-actors.ts',
      }, { onConflict: 'tmdb_id' })
