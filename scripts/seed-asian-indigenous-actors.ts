/**
 * Seeds Asian, South Asian, Indigenous/Native, Southeast Asian,
 * Pacific Islander actors. Skips anyone already in DB. Safe to re-run.
 * Run with: npx tsx scripts/seed-asian-indigenous-actors.ts
 */
...
const ACTORS = [
  ...
  'Ken Jeong', 'Randall Park', 'Jimmy O. Yang', 'Lewis Tan', 'Charles Melton',
  'Ross Butler', 'Remy Hii', 'Ronny Chieng', 'Awkwafina', 'Constance Wu',
  'Gemma Chan', 'Michelle Yeoh', 'Lucy Liu', 'Sandra Oh', 'Lana Condor',
  'Karen Fukuhara', 'Anna Sawai', 'Ming-Na Wen', 'Daniel Wu', 'Chloe Bennet',

  // South Asian
  'Dev Patel', 'Riz Ahmed', 'Kunal Nayyar', 'Sendhil Ramamurthy',
  'Naveen Andrews', 'Adil Hussain', 'Rahul Kohli', 'Nikesh Patel',
  'Himesh Patel', 'Rish Shah', 'Maulik Pancholy', 'Utkarsh Ambudkar',
  'Karan Soni', 'Danny Pudi', 'Suraj Sharma', 'Parvesh Cheena',
  'Richa Moorjani', 'Pooja Lodhia', 'Priyanka Chopra', 'Deepika Padukone',
  'Freida Pinto', 'Mindy Kaling', 'Aziz Ansari', 'Hasan Minhaj',
  'Aparna Nancherla',

  // Indigenous / Native American / First Nations
  'Adam Beach', 'Tantoo Cardinal', 'Gary Farmer', 'Graham Greene',
  'Wes Studi', 'Zahn McClarnon', 'Gil Birmingham', 'Lily Gladstone',
  'Devery Jacobs', 'Crystle Lightning', 'Jennifer Podemski', 'Cara Gee',
  'Lorne Cardinal', 'Tina Keeper', 'Raoul Trujillo', 'Michael Greyeyes',
  'Kiowa Gordon', 'Amber Midthunder', 'Paulina Alexis', 'Joel Oulette',
  'Forrest Goodluck', 'Martin Sensmeier', 'Bronson Pelletier',
  'Chaske Spencer',

  // Southeast Asian
  'Iko Uwais', 'Joe Taslim', 'Tony Jaa', 'Dante Basco', 'Hayden Szeto',
  'Osric Chau',

  // Mixed / Pacific Islander
  'Dwayne Johnson', 'Jason Momoa', 'Temuera Morrison', 'Cliff Curtis',
  'Lawrence Makoare', 'Manu Bennett', 'Mark Dacascos', 'Will Yun Lee',
  'Byron Mann', 'Sung Kang',

  // East Asian cinema crossing to English
  'Tony Leung', 'Donnie Yen', 'Chow Yun-fat', 'Jet Li', 'Jackie Chan',
]
  ...
  for (const name of unique) {
    try {
      ...
      const { error } = await supabase.from('actors').upsert({
        ...
        known_for,
        keywords: 'asian; diverse',
        casting_profile,
        race_ethnicity: 'asian',
        notes: 'seeded via seed-asian-indigenous-actors.ts',
      }, { onConflict: 'tmdb_id' })
