/**
 * Seeds British Black/Asian, French Black/North African, German/European BAME,
 * Spanish/Italian, and Scandinavian diverse actors.
 * Skips anyone already in DB. Safe to re-run.
 * Run with: npx tsx scripts/seed-international-diverse-actors.ts
 */
...
const ACTORS = [
  // British Black
  'Idris Elba', 'Daniel Kaluuya', 'John Boyega', 'David Oyelowo',
  'Chiwetel Ejiofor', 'Adrian Lester', 'Paterson Joseph', 'Lennie James',
  'Ashley Thomas', 'Nathan Stewart-Jarrett', 'Malachi Kirby', 'Wunmi Mosaku',
  'Sope Dirisu', 'Fisayo Akinade', 'Gershwyn Eustache Jnr', 'Tosin Cole',
  'Ncuti Gatwa', 'Micheal Ward', 'Jack Lowden', 'Damson Idris',
  'Letitia Wright', 'Naomie Harris', 'Thandiwe Newton', 'Freema Agyeman',
  'Nathalie Emmanuel',

  // British South Asian
  'Riz Ahmed', 'Dev Patel', 'Nikesh Patel', 'Himesh Patel', 'Rish Shah',
  'Archie Panjabi', 'Preeya Kalidas', 'Meera Syal', 'Sanjeev Bhaskar',
  'Nitin Ganatra', 'Art Malik', 'Naveen Andrews', 'Adil Hussain',
  'Indira Varma', 'Priyanka Bose', 'Mandip Gill', 'Amita Suman',
  'Simone Ashley', 'Charithra Chandran', 'Shelley Conn',

  // British East Asian
  'Gemma Chan', 'Michelle Yeoh', 'Remy Hii', 'Lewis Tan', 'David Yip',
  'Anna Sawai', 'Eleanor Matsuura', 'Elizabeth Tan',

  // French Black
  'Omar Sy', 'Sami Bouajila', 'Isaach De Bankolé', 'Eriq Ebouaney',
  'Firmine Richard', 'Aissa Maiga', 'Stefi Celma', 'Karidja Touré',
  'Déborah Lukumuena', 'Eye Haïdara',

  // French North African
  'Tahar Rahim', 'Roschdy Zem', 'Leïla Bekhti', 'Sabrina Ouazani',
  'Hafsia Herzi', 'Reda Kateb', 'Slimane Dazi', 'Ramzy Bedia',

  // German / Continental European diverse
  'Sibel Kekilli', 'Karoline Herfurth', 'Nora Tschirner',
  'Wotan Wilke Möhring', 'Fahri Yardim', 'Kida Khodr Ramadan',
  'Denis Moschitto', 'Almila Bagriacik', 'Maryam Zaree',

  // Spanish / Italian diverse (Money Heist etc.)
  'Miguel Ángel Silvestre', 'Alba Flores', 'Hovik Keuchkerian',
  'Darko Peric', 'Luka Peros', 'Moussa Mansaly',
  'Álvaro Morte', 'Jaime Lorente', 'Miguel Herrán',

  // Scandinavian diverse
  'Yetide Badaki', 'Fares Fares', 'Adam Lundgren',
]
  ...
  for (const name of unique) {
    try {
      ...
      const { error } = await supabase.from('actors').upsert({
        ...
        known_for,
        keywords: 'international; diverse',
        casting_profile,
        notes: 'seeded via seed-international-diverse-actors.ts',
      }, { onConflict: 'tmdb_id' })
