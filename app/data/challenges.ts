...
const CHALLENGES: Challenge[] = [
  ...
  // 8b
  {
    id: 'sorkverse-pulp-fiction',
    label: 'Casting Challenge',
    headline: 'Recast Pulp Fiction — Sorkin universe only',
    teaser: 'Recast Pulp Fiction.\nBut Aaron Sorkin actors only.',
    description: 'Vincent and Jules walk into a diner. Everybody talks very fast. Every role in Pulp Fiction must be filled by an actor from the Aaron Sorkin universe — The West Wing, The Social Network, A Few Good Men, The Newsroom, Moneyball. The gimp has an excellent vocabulary.',
    badge: '💼',
    movie_slug: 'pulp-fiction',
    actor_filter: { universe_tag: 'SorkVerse' },
    actor_pool: [],
    active: true,
    starts: '2026-04-09',
    ends: '2026-12-31',
